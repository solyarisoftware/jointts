 ...
 */
function googleTranslateTTS(sentence, filename, languageCode, speed=NORMAL_SPEED) {
  return new Promise( (resolve, reject) => {

    if ( ! validIsoCode(languageCode) )
      reject( `ERROR: on function googleTranslateTTS. Invalid language code: ${languageCode}` )
...
function helpAndExit(programName) {
  ...
  console.log(`    ${programName} mi chiamo Giorgio Robino e sono nato a Genova, in Italia. --language=it-IT --speed=0.2`)
